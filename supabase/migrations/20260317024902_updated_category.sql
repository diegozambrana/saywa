...
grant update on table "public"."tags" to "postgres";
  ...
  create policy "base_policies 1twvzjd_0"
  on "storage"."objects"
  as permissive
  for select
  to public
using ((bucket_id = 'profile'::text));
  ...
  create policy "base_policies 1twvzjd_1"
  on "storage"."objects"
  as permissive
  for insert
  to public
with check ((bucket_id = 'profile'::text));



  create policy "base_policies 1twvzjd_2"
  on "storage"."objects"
  as permissive
  for update
  to public
using ((bucket_id = 'profile'::text));
  ...
  create policy "base_policies 1twvzjd_3"
  on "storage"."objects"
  as permissive
  for delete
  to public
